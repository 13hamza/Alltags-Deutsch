...
const STORIES = [
  ...
  },
  {
    ...
    icon: "💼",
    number: "01",
    title: { de: "Die neue Stelle", en: "The New Job" },
    tagline: "Aylin zieht für einen neuen Job nach Hamburg — und merkt, dass der Anfang schwerer ist als gedacht.",
    taglineEn: "Aylin moves to Hamburg for a new job — and realises the beginning is harder than she expected.",
    paragraphs: [
      "Nachdem Aylin monatelang Bewerbungen geschrieben hatte, bekam sie endlich eine Zusage von einer Softwarefirma in Hamburg. Obwohl sie sich sehr freute, war sie auch nervös, denn sie hatte bisher immer in ihrer Heimatstadt gelebt und kannte in Hamburg niemanden.",
      "An ihrem ersten Arbeitstag wurde sie von ihrem Chef, Herrn Brandt, sehr freundlich begrüßt. Er zeigte ihr das Büro, stellte sie den Kollegen vor und erklärte ihr, welche Aufgaben sie in den nächsten Wochen übernehmen sollte. Allerdings sprachen alle so schnell, dass Aylin sich kaum die Namen merken konnte.",
      "In den ersten Wochen fühlte sie sich oft überfordert. Die Besprechungen waren lang, viele Abkürzungen verstand sie nicht, und abends war sie so erschöpft, dass sie keine Lust hatte, die Stadt kennenzulernen. Manchmal fragte sie sich, ob die Entscheidung, umzuziehen, wirklich richtig gewesen war.",
      "Eines Tages lud ihre Kollegin Jana sie ein, nach der Arbeit mit ein paar Leuten aus dem Team etwas trinken zu gehen. Aylin wollte zuerst absagen, weil sie müde war, doch dann überlegte sie es sich anders. Es wurde ein lustiger Abend, an dem sie mehr über ihre Kollegen erfuhr als in den ganzen Wochen davor.",
      "Von da an wurde vieles leichter. Wenn sie etwas nicht verstand, traute sie sich, nachzufragen, und sie merkte, dass niemand erwartete, dass sie schon alles wusste. Jana zeigte ihr am Wochenende den Hafen, die besten Cafés und einen kleinen Markt, auf dem man frischen Fisch kaufen konnte.",
      "Nach drei Monaten hatte Aylin ihr erstes Mitarbeitergespräch. Herr Brandt lobte ihre Arbeit und sagte, dass das Team sehr zufrieden mit ihr sei. Auf dem Heimweg lächelte Aylin: Hamburg fühlte sich zum ersten Mal wie ein Zuhause an."
    ]
  },
  {
    id: "die-wohnungssuche",
    level: "B1",
    icon: "🏠",
    number: "02",
    title: { de: "Die Wohnungssuche", en: "The Flat Hunt" },
    tagline: "Tobias sucht in München eine bezahlbare Wohnung — eine fast unmögliche Aufgabe.",
    taglineEn: "Tobias is looking for an affordable flat in Munich — an almost impossible task.",
    paragraphs: [
      "Wer schon einmal in München eine Wohnung gesucht hat, weiß, wie schwierig das sein kann. Tobias studiert Maschinenbau und wohnte bisher in einem Studentenwohnheim, doch sein Vertrag endet im Sommer. Deshalb muss er so schnell wie möglich etwas Neues finden.",
      "Jeden Morgen durchsucht er die Anzeigen im Internet. Die meisten Wohnungen sind entweder viel zu teuer oder schon vergeben, bevor er überhaupt anrufen kann. Wenn er doch einmal zu einer Besichtigung eingeladen wird, stehen dort oft zwanzig oder dreißig andere Interessenten.",
      "Bei einer Besichtigung in Schwabing verlangte der Vermieter sogar eine Kaution von drei Monatsmieten, eine Gehaltsbescheinigung und eine Bürgschaft der Eltern. Tobias füllte trotzdem alle Formulare aus, aber eine Woche später bekam er eine Absage per E-Mail.",
      "Langsam verlor er die Hoffnung. Seine Freundin Lena schlug ihm vor, es mit einer Wohngemeinschaft zu versuchen. Zuerst war Tobias skeptisch, weil er gern allein wohnen wollte, aber schließlich meldete er sich auf eine Anzeige für ein Zimmer in einer Dreier-WG.",
      "Beim Kennenlernen saßen die zukünftigen Mitbewohner mit ihm in der Küche, tranken Tee und stellten ihm viele Fragen: ob er koche, wie ordentlich er sei und was er in seiner Freizeit mache. Tobias erzählte, dass er gern backe und am Wochenende Fahrrad fahre. Die beiden anderen lachten, denn einer von ihnen war Konditor.",
      "Zwei Tage später kam der Anruf: Das Zimmer gehörte ihm. Heute, ein halbes Jahr später, ist Tobias froh, dass es damals mit der eigenen Wohnung nicht geklappt hat. Statt allein zu essen, kocht er jetzt fast jeden Abend mit seinen Mitbewohnern, und sonntags gibt es selbstgebackenen Kuchen."
    ]
  },
  {
    id: "der-termin-beim-amt",
    level: "B1",
    icon: "🏛️",
    number: "03",
    title: { de: "Der Termin beim Amt", en: "The Appointment at the Office" },
    tagline: "Carlos muss sich in Köln anmelden — und lernt die deutsche Bürokratie kennen.",
    taglineEn: "Carlos has to register his address in Cologne — and gets to know German bureaucracy.",
    paragraphs: [
      "Als Carlos aus Spanien nach Köln zog, erklärte ihm seine Nachbarin, dass man sich innerhalb von zwei Wochen beim Bürgeramt anmelden müsse. Ohne Anmeldung könne man kein Bankkonto eröffnen, keinen Handyvertrag abschließen und manchmal nicht einmal einen Arbeitsvertrag unterschreiben.",
      "Carlos versuchte sofort, online einen Termin zu vereinbaren, aber der nächste freie Termin war erst in sechs Wochen. Ein Kollege gab ihm den Tipp, jeden Morgen um sieben Uhr auf die Webseite zu schauen, weil dann manchmal kurzfristig Termine frei würden. Nach vier Tagen hatte er Glück.",
      "Am Tag des Termins nahm er alle Unterlagen mit, die er finden konnte: seinen Reisepass, den Mietvertrag und eine Bestätigung des Vermieters. Im Wartesaal zog er eine Nummer und setzte sich zu den anderen Leuten, die geduldig auf den Bildschirm starrten.",
      "Als seine Nummer endlich aufgerufen wurde, ging er in Zimmer zwölf. Die Sachbearbeiterin war sachlich, aber freundlich. Sie prüfte seine Dokumente und runzelte plötzlich die Stirn: Auf der Wohnungsgeberbestätigung fehlte die Unterschrift des Vermieters.",
      "Carlos erschrak, denn er wollte auf keinen Fall noch einmal sechs Wochen warten. Die Beamtin überlegte kurz und schlug dann vor, dass er den Vermieter anrufen und ihn bitten solle, das unterschriebene Formular per E-Mail zu schicken. Zum Glück war der Vermieter sofort erreichbar.",
      "Zwanzig Minuten später hielt Carlos seine Meldebescheinigung in der Hand. Auf dem Weg nach draußen dachte er, dass die deutsche Bürokratie zwar kompliziert sei, dass man aber mit Geduld und etwas Freundlichkeit fast alles erreichen könne. Am Abend feierte er seinen kleinen Erfolg mit einem Kölsch."
    ]
  },
  {
    id: "die-reklamation",
    ...
    icon: "📦",
    number: "04",
    title: { de: "Die Reklamation", en: "The Complaint" },
    tagline: "Frau Weber bestellt eine Waschmaschine online — doch es wird die falsche geliefert.",
    taglineEn: "Mrs Weber orders a washing machine online — but the wrong one is delivered.",
    paragraphs: [
      "Nachdem ihre alte Waschmaschine nach fünfzehn Jahren kaputtgegangen war, bestellte Frau Weber im Internet ein neues Gerät. Sie verglich lange die Preise und entschied sich schließlich für ein Modell, das besonders leise und sparsam sein sollte. Die Lieferung wurde für den folgenden Dienstag angekündigt.",
      "Am Dienstag klingelten zwei Männer und trugen ein riesiges Paket in den Keller. Erst als sie wieder weg waren, öffnete Frau Weber den Karton und stellte fest, dass es sich um einen Trockner handelte, nicht um eine Waschmaschine. Außerdem war die Seitenwand an einer Stelle eingedrückt.",
      "Sie rief sofort beim Kundenservice an, landete aber in einer Warteschleife mit langweiliger Musik. Nach einer halben Stunde meldete sich endlich ein Mitarbeiter. Er entschuldigte sich für den Fehler und bat sie, eine schriftliche Reklamation mit Fotos und der Bestellnummer zu schicken.",
      "Frau Weber setzte sich an den Computer und schrieb eine höfliche, aber deutliche E-Mail. Sie beschrieb das Problem genau, fügte die Fotos hinzu und verlangte, dass man den Trockner abholt und so schnell wie möglich die richtige Maschine liefert. Sie wies auch darauf hin, dass sie ohne Waschmaschine ihre Wäsche in den Waschsalon bringen müsse.",
      "Zwei Tage später kam die Antwort: Die Firma bedauerte den Vorfall, versprach eine Lieferung innerhalb einer Woche und bot ihr als Entschädigung einen Gutschein über fünfzig Euro an. Frau Weber war zufrieden, auch wenn sie sich über den Stress geärgert hatte.",
      "Als die richtige Waschmaschine schließlich ankam, prüfte sie diesmal alles, bevor die Lieferanten gingen. Ihre Enkelin lachte darüber und meinte, Oma sei jetzt eine richtige Expertin für Reklamationen. Frau Weber antwortete stolz, dass man sich eben nicht alles gefallen lassen dürfe."
    ]
  },
  {
    id: "das-ehrenamt",
    ...
    icon: "🤝",
    number: "05",
    title: { de: "Das Ehrenamt", en: "The Volunteer Work" },
    tagline: "Ein Rentner findet nach seiner Pensionierung eine neue Aufgabe in der Nachbarschaft.",
    taglineEn: "A pensioner finds a new purpose in his neighbourhood after retiring.",
    paragraphs: [
      "Herr Schulz hatte vierzig Jahre lang als Elektriker gearbeitet. Als er in Rente ging, freute er sich zunächst auf die freie Zeit: lange schlafen, Zeitung lesen, im Garten arbeiten. Doch schon nach ein paar Monaten langweilte er sich und hatte das Gefühl, nicht mehr gebraucht zu werden.",
      "Eines Morgens las er im Gemeindeblatt, dass ein Repair-Café in seinem Stadtteil ehrenamtliche Helfer suche. Dort können Menschen kaputte Geräte, Fahrräder oder Kleidung vorbeibringen und sie gemeinsam mit Freiwilligen reparieren, anstatt sie wegzuwerfen.",
      "Herr Schulz zögerte nicht lange und meldete sich bei der Organisatorin, einer jungen Studentin namens Mia. Sie freute sich sehr, denn Elektriker wurden dringend gesucht. Schon am nächsten Samstag stand er mit seinem alten Werkzeugkoffer im Gemeindehaus.",
      "Der erste Besucher war ein kleiner Junge mit einem Radio, das seinem Großvater gehört hatte. Herr Schulz öffnete das Gerät vorsichtig, erklärte dem Jungen jeden Schritt und fand schließlich ein loses Kabel. Als das Radio wieder Musik spielte, strahlte der Junge über das ganze Gesicht.",
      "Seitdem geht Herr Schulz jeden Samstag ins Repair-Café. Er hat dort nicht nur viele Toaster, Lampen und Staubsauger repariert, sondern auch neue Freunde gefunden. Besonders gern arbeitet er mit den jungen Leuten zusammen, die von ihm lernen wollen und ihm im Gegenzug erklären, wie sein Smartphone funktioniert.",
      "Wenn ihn heute jemand fragt, wie es ihm in der Rente geht, antwortet er, dass er nie zufriedener gewesen sei. Er ist überzeugt, dass es wichtig ist, eine Aufgabe zu haben, und dass man anderen am besten hilft, indem man das teilt, was man selbst gut kann."
    ]
  },
  {
    id: "die-wanderung-in-den-alpen",
    level: "B1",
    icon: "⛰️",
    number: "06",
    title: { de: "Die Wanderung in den Alpen", en: "The Hike in the Alps" },
    tagline: "Zwei Schwestern unterschätzen das Wetter in den Bergen.",
    taglineEn: "Two sisters underestimate the weather in the mountains.",
    paragraphs: [
      "Katrin und ihre jüngere Schwester Sophie hatten sich schon lange vorgenommen, gemeinsam eine Hüttenwanderung in den bayerischen Alpen zu machen. Im August war es endlich so weit. Sie hatten die Route sorgfältig geplant, eine Übernachtung auf einer Berghütte reserviert und ihre Rucksäcke mit allem Nötigen gepackt.",
      "Der Aufstieg am ersten Tag war anstrengend, aber wunderschön. Die Sonne schien, die Luft war klar, und von oben konnten sie mehrere Seen im Tal sehen. Auf der Hütte aßen sie Kaiserschmarrn und unterhielten sich mit anderen Wanderern, die ihnen von ihren Touren erzählten.",
      "Am nächsten Morgen warnte der Hüttenwirt, dass am Nachmittag Gewitter möglich seien. Sophie wollte trotzdem den längeren Weg über den Grat nehmen, weil die Aussicht dort angeblich spektakulär war. Katrin hatte zwar ein ungutes Gefühl, ließ sich aber überreden.",
      "Gegen Mittag zogen tatsächlich dunkle Wolken auf, und in der Ferne hörten sie den ersten Donner. Die Schwestern merkten, dass sie auf dem Grat völlig ungeschützt waren. Katrin schlug vor, sofort umzukehren und den kürzeren Abstieg durch den Wald zu nehmen, und diesmal widersprach Sophie nicht.",
      "Sie liefen so schnell sie konnten, während es anfing, heftig zu regnen. Als sie endlich den Waldrand erreichten, waren sie bis auf die Haut nass, aber in Sicherheit. In einer kleinen Almhütte durften sie sich aufwärmen, bis das Gewitter vorbei war.",
      "Am Abend, zurück im Tal, lachten die beiden über ihr Abenteuer, auch wenn ihnen klar war, dass es gefährlich hätte werden können. Sophie gab zu, dass sie die Warnung ernster hätte nehmen sollen. Beim nächsten Mal, versprachen sie sich, würden sie früher losgehen und auf den Rat der Einheimischen hören."
    ]
  },
];
...
const GLOSSARY = {
  ...
  "übt": "practices",
  /* ---- B1 stories ---- */
  "abends": "in the evening", "abholt": "picks up / collects", "abkürzungen": "abbreviations",
  "absage": "rejection / cancellation", "absagen": "to cancel / decline", "abschließen": "to conclude / sign (a contract)",
  "abstieg": "descent", "allem": "everything (dative)", "allerdings": "however", "almhütte": "alpine hut",
  "alpen": "the Alps", "anders": "differently", "anfing": "began", "angeblich": "supposedly",
  "angekündigt": "announced", "ankam": "arrived", "anmelden": "to register", "anmeldung": "registration",
  "anruf": "phone call", "anstatt": "instead of", "antwort": "answer / reply", "antwortet": "answers",
  "antwortete": "answered", "anzeige": "advertisement / listing", "anzeigen": "advertisements / listings",
  "arbeiten": "to work", "arbeitstag": "working day", "arbeitsvertrag": "employment contract",
  "aufgabe": "task / purpose", "aufgaben": "tasks", "aufstieg": "ascent / climb", "aufwärmen": "to warm up",
  "august": "August", "aussicht": "view", "außerdem": "besides / also", "aylin": "Aylin (name)",
  "aßen": "ate", "backe": "bake", "bankkonto": "bank account", "bat": "asked (bitten)",
  "bayerischen": "Bavarian", "beamtin": "civil servant (female)", "bedauerte": "regretted",
  "begrüßt": "greeted", "beim": "at the / when (bei + dem)", "bekam": "got / received",
  "berghütte": "mountain hut", "beschrieb": "described", "besichtigung": "viewing (of a flat)",
  "besonders": "especially", "besprechungen": "meetings", "bestellnummer": "order number",
  "bestellte": "ordered", "besten": "best", "bestätigung": "confirmation", "besucher": "visitor",
  "bevor": "before", "bis": "until / up to", "bisher": "until now / so far", "bitten": "to ask (for)",
  "bot": "offered", "brandt": "Brandt (name)", "bringen": "to bring / take", "bürgeramt": "citizens' office",
  "bürgschaft": "guarantee (as guarantor)", "bürokratie": "bureaucracy", "cafés": "cafés",
  "carlos": "Carlos (name)", "chef": "boss", "damals": "back then", "darüber": "about it",
  "davor": "before that", "deshalb": "therefore / that's why", "deutliche": "clear",
  "deutsche": "German", "dokumente": "documents", "donner": "thunder", "dreier": "three-person",
  "dreißig": "thirty", "dringend": "urgently", "durften": "were allowed to", "dürfe": "may / is allowed to",
  "e": "e (as in e-mail)", "eben": "simply / just", "ehrenamtliche": "volunteer",
  "eigenen": "own", "eingedrückt": "dented", "einheimischen": "locals", "elektriker": "electrician",
  "eltern": "parents", "endet": "ends", "enkelin": "granddaughter", "entscheidung": "decision",
  "entschied": "decided", "entschuldigte": "apologised", "entschädigung": "compensation",
  "entweder": "either", "erfolg": "success", "erfuhr": "found out / learned",
  "erklären": "to explain", "erklärte": "explained", "ernster": "more seriously",
  "erreichbar": "reachable", "erreichen": "to achieve / reach", "erreichten": "reached",
  "erschrak": "got a fright", "erschöpft": "exhausted", "erste": "first", "erstes": "first",
  "erwartete": "expected", "erzählte": "told", "erzählten": "told", "eröffnen": "to open (an account)",
  "euro": "euro", "expertin": "expert (female)", "fahre": "ride / drive", "fahrrad": "bicycle",
  "fahrräder": "bicycles", "fand": "found", "fehler": "mistake", "fehlte": "was missing",
  "feierte": "celebrated", "ferne": "distance", "finden": "to find", "fisch": "fish",
  "folgenden": "following", "formular": "form", "formulare": "forms", "fotos": "photos",
  "fragte": "asked", "frei": "free / available", "freie": "free", "freiwilligen": "volunteers",
  "freizeit": "free time", "freundlichkeit": "friendliness", "freute": "was happy / looked forward",
  "frischen": "fresh", "froh": "glad", "funktioniert": "works", "fügte": "added",
  "fühlte": "felt", "füllte": "filled (out)", "fünfzehn": "fifteen", "fünfzig": "fifty",
  "gab": "gave", "gebraucht": "needed / used", "geduld": "patience", "geduldig": "patiently",
  "gefährlich": "dangerous", "gefühl": "feeling", "gegenzug": "return (im Gegenzug = in return)",
  "gehaltsbescheinigung": "proof of salary", "gehörte": "belonged", "geklappt": "worked out",
  "gelebt": "lived", "gemeindeblatt": "local newsletter", "gemeindehaus": "community hall",
  "gern": "gladly / like to", "gerät": "appliance / device", "geräte": "appliances / devices",
  "gesicht": "face", "gesucht": "looked for / wanted", "gewitter": "thunderstorm",
  "geärgert": "annoyed", "ging": "went", "gingen": "went", "grat": "ridge",
  "großvater": "grandfather", "gutschein": "voucher", "hafen": "harbour", "halben": "half",
  "halbes": "half", "hamburg": "Hamburg", "handelte": "was (es handelte sich um = it was)",
  "handyvertrag": "mobile phone contract", "hatten": "had", "haut": "skin", "heftig": "heavily",
  "heimatstadt": "hometown", "heimweg": "way home", "helfer": "helpers", "herrn": "Mr",
  "hielt": "held", "hin": "there / towards", "hinzu": "in addition", "hoffnung": "hope",
  "hätte": "would have", "höfliche": "polite", "hören": "to hear / listen",
  "hörten": "heard", "hütte": "hut", "hüttenwanderung": "hut-to-hut hike",
  "hüttenwirt": "hut keeper", "ihrem": "her / their (dative)", "indem": "by (doing)",
  "innerhalb": "within", "interessenten": "interested people / applicants", "internet": "internet",
  "jana": "Jana (name)", "jungen": "young / boy", "jüngere": "younger", "kabel": "cable",
  "kaiserschmarrn": "Kaiserschmarrn (shredded pancake)", "kam": "came", "kannte": "knew",
  "kaputte": "broken", "kaputtgegangen": "broken down", "karton": "cardboard box",
  "katrin": "Katrin (name)", "kaution": "deposit", "keine": "no / none",
  "kennenlernen": "getting to know / to get to know", "kennenzulernen": "to get to know",
  "klar": "clear", "klingelten": "rang the doorbell", "koche": "cook(s)", "kollege": "colleague",
  "kollegen": "colleagues", "kollegin": "colleague (female)", "kompliziert": "complicated",
  "konditor": "pastry chef", "konnte": "could", "konnten": "could", "kundenservice": "customer service",
  "kurzfristig": "at short notice", "köln": "Cologne", "kölsch": "Kölsch (Cologne beer)",
  "könne": "could / can", "können": "can / to be able to", "kürzeren": "shorter",
  "lachte": "laughed", "lachten": "laughed", "lampen": "lamps", "landete": "ended up / landed",
  "lang": "long", "langweiliger": "boring", "langweilte": "was bored", "las": "read",
  "lassen": "to let / leave", "leichter": "easier", "lena": "Lena (name)", "liefen": "ran / walked",
  "lieferanten": "delivery men", "liefert": "delivers", "lieferung": "delivery", "ließ": "let",
  "lobte": "praised", "loses": "loose", "losgehen": "to set off", "lud": "invited",
  "lust": "desire (Lust haben = to feel like)", "lustiger": "fun", "lächelte": "smiled",
  "längeren": "longer", "mache": "do(es)", "mail": "mail", "markt": "market",
  "maschine": "machine", "maschinenbau": "mechanical engineering", "mehrere": "several",
  "meinte": "said / thought", "meldebescheinigung": "registration certificate",
  "meldete": "reported / got in touch", "merken": "to remember", "merkte": "noticed",
  "merkten": "noticed", "mietvertrag": "rental contract", "mitarbeiter": "employee",
  "mitarbeitergespräch": "staff appraisal meeting", "mitbewohner": "flatmates",
  "mitbewohnern": "flatmates", "mittag": "noon", "modell": "model", "monatelang": "for months",
  "monatsmieten": "months' rent", "musik": "music", "männer": "men", "möglich": "possible",
  "münchen": "Munich", "müsse": "must / had to", "nachdem": "after", "nachzufragen": "to ask again",
  "nahm": "took", "namens": "named / called", "nehmen": "to take", "nummer": "number",
  "nächste": "next", "nötigen": "necessary (das Nötige = what's needed)", "oben": "above / up there",
  "oma": "grandma", "online": "online", "ordentlich": "tidy", "organisatorin": "organiser (female)",
  "paket": "package", "per": "by / via", "preise": "prices", "prüfte": "checked",
  "radio": "radio", "rat": "advice", "reisepass": "passport", "reklamation": "complaint",
  "reklamationen": "complaints", "rente": "retirement / pension", "repair": "repair",
  "reparieren": "to repair", "repariert": "repaired", "reserviert": "reserved", "rief": "called",
  "riesiges": "huge", "rucksäcke": "backpacks", "runzelte": "wrinkled (die Stirn runzeln = to frown)",
  "sachbearbeiterin": "case officer (female)", "sachlich": "matter-of-fact", "sagte": "said",
  "saßen": "sat", "schicken": "to send", "schien": "shone / seemed", "schlafen": "to sleep",
  "schließlich": "finally / after all", "schlug": "suggested (vorschlagen)", "schrieb": "wrote",
  "schriftliche": "written", "schritt": "step", "schulz": "Schulz (name)",
  "schwabing": "Schwabing (Munich district)", "schwestern": "sisters", "schwierig": "difficult",
  "seen": "lakes", "sei": "is (reported speech)", "seien": "were / are (reported speech)",
  "seitenwand": "side panel", "setzte": "sat down / put", "sicherheit": "safety",
  "sieben": "seven", "skeptisch": "sceptical", "smartphone": "smartphone",
  "softwarefirma": "software company", "solle": "should (reported speech)", "sollen": "should / to be supposed to",
  "sollte": "should / was supposed to", "sonntags": "on Sundays", "sophie": "Sophie (name)",
  "sorgfältig": "carefully", "spanien": "Spain", "sparsam": "economical", "spektakulär": "spectacular",
  "spielte": "played", "sprachen": "spoke", "stadtteil": "district", "stand": "stood",
  "starrten": "stared", "statt": "instead of", "staubsauger": "vacuum cleaner", "stellte": "put / placed",
  "stellten": "asked (Fragen stellen)", "stirn": "forehead", "strahlte": "beamed",
  "stress": "stress", "studentenwohnheim": "student residence", "studentin": "student (female)",
  "studiert": "studies", "suche": "is looking for", "tal": "valley", "teilt": "shares",
  "termine": "appointments", "termins": "appointment (genitive)", "teuer": "expensive",
  "toaster": "toasters", "touren": "tours / hikes", "tranken": "drank", "traute": "dared",
  "trockner": "tumble dryer", "trugen": "carried", "umzukehren": "to turn back",
  "umzuziehen": "to move (house)", "ungeschützt": "unprotected", "ungutes": "uneasy",
  "unterhielten": "chatted / talked", "unterlagen": "documents", "unterschreiben": "to sign",
  "unterschriebene": "signed", "unterschrift": "signature", "vereinbaren": "to arrange",
  "vergeben": "taken / given away", "verglich": "compared", "verlangte": "demanded",
  "verlor": "lost", "vermieter": "landlord", "vermieters": "landlord's", "versprach": "promised",
  "versprachen": "promised", "verstand": "understood", "versuchen": "to try",
  "versuchte": "tried", "vertrag": "contract", "vieles": "a lot / many things", "vier": "four",
  "vierzig": "forty", "vorbeibringen": "to drop off", "vorfall": "incident",
  "vorgenommen": "planned / resolved", "waldrand": "edge of the forest", "wanderern": "hikers",
  "waren": "were", "warnte": "warned", "warnung": "warning", "warten": "to wait",
  "wartesaal": "waiting room", "warteschleife": "hold queue (on the phone)",
  "waschmaschine": "washing machine", "waschsalon": "laundrette", "weber": "Weber (name)",
  "webseite": "website", "wegzuwerfen": "to throw away", "welche": "which",
  "werkzeugkoffer": "toolbox", "wg": "shared flat (WG)", "wichtig": "important",
  "widersprach": "contradicted / objected", "wies": "pointed out (hinweisen)",
  "wirklich": "really", "wohngemeinschaft": "shared flat", "wohnte": "lived",
  "wohnungen": "flats / apartments", "wohnungsgeberbestätigung": "landlord's confirmation of residence",
  "wollen": "to want", "wurde": "was / became", "wurden": "were / became", "wusste": "knew",
  "wäsche": "laundry", "würden": "would", "zeigte": "showed", "zeitung": "newspaper",
  "zog": "moved / pulled", "zogen": "moved in / gathered (clouds)", "zufrieden": "satisfied",
  "zufriedener": "more content", "zuhause": "home", "zukünftigen": "future",
  "zunächst": "at first", "zusage": "acceptance / offer", "zwar": "admittedly / indeed",
  "zwölf": "twelve", "zögerte": "hesitated", "öffnete": "opened",
  "überfordert": "overwhelmed", "überlegte": "thought about / reconsidered",
  "übernachtung": "overnight stay", "übernehmen": "to take on", "überreden": "to persuade",
  "überzeugt": "convinced",
};
...
function getStoriesByLevel(level) {
  if (level === "ALL" || level === "All") {
    return STORIES.filter(s => s.level === "A1" || s.level === "A2" || s.level === "B1");
  }
